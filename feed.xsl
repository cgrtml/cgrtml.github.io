    ...
    <html lang="en">
      ...
      <body>
        <div class="container top">
          ...
          <div class="note">
            <p><strong>This is an RSS feed.</strong> It is meant for feed readers, not browsers. Your browser cannot display it on its own, so this page renders it for you.</p>
            <p>To subscribe, paste this address into a reader such as Feedly, Inoreader or NetNewsWire:<br />
